...
SpreadSheet.prototype.initialize = function(){
    ...
    return fs.readFileAsync(spreadsheet_this.spreadsheet_path)
        .then(function(data){
            ...
            return Promise.all([
                parseString(spreadsheet_this.zip.file('xl/sharedStrings.xml').asText()),
                parseString(spreadsheet_this.zip.file('xl/_rels/workbook.xml.rels').asText()),
                parseString(spreadsheet_this.zip.file('xl/workbook.xml').asText()),
                spreadsheet_this._parse_dir_in_excel('xl/worksheets')
