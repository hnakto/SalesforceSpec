...
SalesforceSpec.prototype.debug = function(){
    console.log('this.salesforce_username=' + this.salesforce_username);
}
/**
 * * retrieve_package
...
SalesforceSpec.prototype.retrieve_package = function(){
    ...
    return new Promise(function(resolve, reject){
        ...
        fs.readFile(config_file, function (err, data) {
            ...
            tmp.dir({dir:temporary_directory},function(err, dir) {
                if (err)
                    reject(err);
                conn.login(salesforce_username, salesforce_password, function(err, res) {
                    if (err)
                        reject(err);
